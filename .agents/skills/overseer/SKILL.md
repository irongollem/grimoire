---
name: overseer
description: Run a significant story as overseer + executor subagents — story slicing, spec template, file-disjoint waves, and the integration gate. Invoke at the start of any issue-sized feature or multi-file refactor; AGENTS.md makes this the default execution model.
user-invocable: true
---
...
and review; `sonnet` subagents type. AGENTS.md's "Overseer Pattern" section makes
...
- **Applicable conventions** — the AGENTS.md/memory rules that bite for this story
