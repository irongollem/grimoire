...
## Fix log by subsystem  ·  301 resolved
...
| [Encounters & Combat](docs/log/fixes/encounters.md) | 25 | | [Soundboard](docs/log/fixes/soundboard.md) | 20 |
| [Quests](docs/log/fixes/quests.md) | 13 | | [Miscellaneous](docs/log/fixes/misc.md) | 1 |
| [Party & Characters](docs/log/fixes/party.md) | 25 | | | |

## Latest fixes

- CarPlay playback skipped 1–3 s chunks — iOS suspends the AudioContext with the screen locked and nothing resumed it; the context now auto-resumes on its own statechange while audio is audible — [Soundboard](docs/log/fixes/soundboard.md)
