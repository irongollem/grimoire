...
- **The standing security-advisor baseline is 95 findings, measured against production 23 Aug 2026 (was 87 on 12 Aug); the audit behind it was 9 Aug 2026 — not merely inherited.** Treat that number as the line: a new finding is a regression, but the 95 are not a backlog to "clean up". Note the breakdown below sums to the total — an earlier revision of this line said 92 over a breakdown summing to 90, which is how a baseline stops being checkable. They are, in full:
