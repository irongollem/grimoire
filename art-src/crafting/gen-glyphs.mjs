...
writeFileSync(
  outFile,
  `// AUTO-GENERATED by art-src/crafting/gen-glyphs.mjs — do not edit by hand.\n` +
    `// Inner SVG markup for custom crafting-discipline glyphs, normalized to a 0 0 100 100 viewBox.\n` +
    `export const CRAFTING_GLYPHS = {\n${body}\n} as const;\n`,
);
