...
*The Pro waitlist stood here — `pro_waitlist`, its `disposable_email_domains`
signup guard, and the `checkout_config.pro_signup_open` switch that chose
between the waitlist form and the checkout buttons. Migration
`20260923181129` removed the whole apparatus on 23 Sep 2026, the day Pro
checkout opened, having never held a single row.*
