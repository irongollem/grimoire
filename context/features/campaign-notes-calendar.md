...
This registry is groundwork for #763 (an Arrange mode that edits a layout) — see epic #760. `title`/`description` on each catalogue entry exist for #763's shelf and are otherwise unused today.
