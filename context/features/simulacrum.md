...
| `src/composables/simulacrum/useSimulacrumConfig.ts` | Mode query (all users) + admin mutation                                                                                                                                                                                                                          |
| `src/composables/simulacrum/useMinis.ts`     | List/single/delete (delete via edge fn — no client storage policy)                                                                                                                                                                                                      |
| `src/composables/simulacrum/useFeatureInterest.ts` | Teaser notify-me + admin count                                                                                                                                                                                                                                    |
