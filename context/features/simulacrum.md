...
| The **base is added at the image step** (prompt directive)                    | Meshy meshes whatever is in the picture; there is no add-base mesh param. Print minis need the base for stability anyway.                                                                                   |
