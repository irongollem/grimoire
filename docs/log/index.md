...
- **Fixes** (298 entries) — resolved bugs, newest first per file.
...
Pick the subsystem the change is primarily about; use `misc` only as a last resort.

## Features — `docs/log/features/`
...
| Publishing & Export | 52 | [features/publishing.md](features/publishing.md) |
...
| Subsystem | Count | File |
| --- | ---: | --- |
| Campaign | 12 | [fixes/campaign.md](fixes/campaign.md) |
...
| Spells | 6 | [fixes/spells.md](fixes/spells.md) |
...
| Party & Characters | 25 | [fixes/party.md](fixes/party.md) |
...
| Soundboard | 20 | [fixes/soundboard.md](fixes/soundboard.md) |
