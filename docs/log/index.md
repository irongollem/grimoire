...
- **Features** (537 entries) — what shipped, newest first per file.
- **Fixes** (252 entries) — resolved bugs, newest first per file.
...
| Soundboard | 12 | [features/soundboard.md](features/soundboard.md) |
...
| Soundboard | 4 | [fixes/soundboard.md](fixes/soundboard.md) |
