    ...
    <template v-else-if="local">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <label class="space-y-1">
          <span class="block font-cinzel text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">New-account age (days)</span>
        ...
        <label class="space-y-1">
          <span class="block font-cinzel text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">Window (hours)</span>
        ...
        <label class="space-y-1">
          <span class="block font-cinzel text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">Max purchased / window</span>
