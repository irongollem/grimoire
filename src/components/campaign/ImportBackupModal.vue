<template>
  <AppModal :open="open" size="md" @close="close">
    <ModalHeader title="Import Campaign Backup" closeable @close="close" />
...
import { useImportCampaign } from "@/composables/campaign/useCampaignBackup";
import type { BackupPreview } from "@/composables/campaign/useCampaignBackup";
