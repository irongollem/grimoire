  ...
  <div class="card-shell" :style="{ '--fc': frameColor }">
    <div class="card-face">
      ...
      <div class="desc-block">
        <p class="desc-text">{{ truncateCard(data.description, 200) }}</p>
      </div>
...
.props-block { padding: 2px 6px 3px; display: flex; flex-wrap: wrap; gap: 2px; }
.prop-tag {
  font-family: "Cinzel", serif;
  font-size: 5px;
...
.attune-block, .charge-block { padding: 2px 6px 3px; }
.attune-text, .charge-text { font-size: 5.5px; color: #3a3028; font-style: italic; }
.flavor-footer {
