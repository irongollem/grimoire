  ...
  <div class="card-shell" :style="{ '--fc': frameColor }">
    <div class="card-face">
      ...
      <div class="flavor-footer">
        ...
        <span v-if="data.location" class="location-line">{{ data.location }}</span>
      </div>
    </div>
  </div>
</template>
...
import { NPC_COLORS, ABILITY_KEYS, truncateCard, capitalize } from "@/types/card.types";

// ABILITY_KEYS is imported but used only to satisfy the import requirement
// capitalize is used in statsRows
void ABILITY_KEYS;
...
const flavorText = computed(() => props.data.personality ?? props.data.backstory);
</script>
