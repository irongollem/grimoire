...
const map = {
  inked: { npc: InkedNpcFront, monster: InkedMonsterFront, item: InkedItemFront, spell: InkedSpellFront, downtime: InkedDowntimeFront },
  modern: { npc: ModernNpcFront, monster: ModernMonsterFront, item: ModernItemFront, spell: ModernSpellFront, downtime: ModernDowntimeFront },
} as const;
