  ...
  <div class="ik-shell" :class="{ tarot }" :style="{ '--fc': frameColor }">
    <div class="ik-art">
      ...
      <div v-else class="ik-art-ph">
        <span class="ik-art-glyph">{{ data.school.charAt(0).toUpperCase() }}</span>
        <span class="ik-art-label">{{ data.school }}</span>
      </div>
      <div class="ik-scrim" />
    </div>
    <div class="ik-top">
      <div class="ik-type-tag">SPELL · {{ data.school.toUpperCase() }}</div>
