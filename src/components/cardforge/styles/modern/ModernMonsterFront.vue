<template>
  <ModernShell :tarot face="front" :accent="accentForMonster(data)">
    <div class="md-art">
      <FocalImage
        v-if="portrait"
        :src="portrait"
      ...
      <div v-else class="md-art-ph">
        <span class="md-art-glyph">{{ monsterType.charAt(0).toUpperCase() }}</span>
        <span class="md-art-label">{{ monsterType }}</span>
      </div>
    </div>
    <div class="md-scrim" />
