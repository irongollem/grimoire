<template>
  <aside class="flex flex-row flex-wrap lg:flex-col lg:flex-nowrap gap-1 lg:w-44 shrink-0 bg-card border border-border rounded-lg p-2">
    ...
    <div v-if="planTool === 'space' || planTool === 'zone'" class="w-full mt-2 border-t border-border pt-2">
    ...
    <p v-if="planTool === 'door'" class="w-full mt-2 border-t border-border pt-2 text-caption-sm text-muted-foreground">
