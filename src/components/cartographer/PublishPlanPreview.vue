 ...
 *
 * Zones are not part of this preview (#884 S11) — a zone is now a Plan
 * region authored once in the Plan palette, never derived from (or
 * published from) the Drawing.
 */
...
const viewBox = computed(
  () =>
    planViewBox(Object.values(bucketedCells.value)) ?? {
      minX: 0,
      minY: 0,
      width: 1,
      height: 1,
