...
export const A4: SizeConfig = {
  classic: {
    front: {
      ...
      fields: [
        ...
        { section: "attacks", box: [31, 44.4, 61, 9.7] },
        {
          section: "skills",
        ...
        { section: "passperc", box: [19.6, 85.7, 3.8, 2.6] },
        { section: "profbonus", box: [19.6, 90.3, 3.8, 2.6] },
  ...
  adventure: {
    front: {
      ...
      fields: [
        { section: "name", box: [27, 8.4, 56, 3.8] },
        ...
        { section: "hp", box: [34.5, 30.2, 15, 7] },
        { section: "hitdice", box: [52, 30.2, 14, 7] },
        { section: "death", box: [31, 42, 36, 2.7] },
        { section: "portrait", box: [70.5, 17.5, 20.4, 22.9] },
        { section: "attacks", box: [33.5, 50, 54, 9.7] },
        {
          section: "skills",
          box: [7.6, 62.6, 19.4, 23],
          opts: { fontSize: 10 },
        },
        { section: "equipment", box: [30, 63.4, 26, 21.5] },
        { section: "features", box: [57.8, 63.4, 34, 21.5] },
        { section: "passperc", box: [19.6, 88.1, 3.8, 2.6] },
        { section: "profbonus", box: [19.6, 92.7, 3.8, 2.6] },
        { section: "notes", box: [30.2, 89.6, 61.5, 7] },
      ],
    },
    back: {
  ...
  gothic: {
    ...
    back: {
      ...
      fields: [
        { section: "appearance", box: [14.5, 13.5, 15.5, 15.5], opts: { lines: 8 } },
  ...
  fairy: {
    ...
    back: {
      ...
      fields: [
        { section: "appearance", box: [11.5, 17.5, 20.5, 16], opts: { lines: 7 } },
  ...
  sumie: {
    ...
    back: {
      ...
      fields: [
        { section: "appearance", box: [9.8, 9.5, 27.5, 21], opts: { lines: 8 } },
