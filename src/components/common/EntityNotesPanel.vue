<template>
  <div class="flex flex-col gap-3">
        ...
        <div v-if="editingId === note.id" class="p-3 flex flex-col gap-2">
          ...
          <div class="flex items-center gap-2">
            <label class="flex items-center gap-1.5 cursor-pointer select-none">
              ...
              <span class="font-cinzel text-[10px] tracking-wider text-muted-foreground">Private</span>
            </label>
    ...
    <div v-if="composing" class="rounded-md border border-border bg-card overflow-hidden">
      <div class="px-3 py-1.5 border-b border-border bg-muted/30 font-cinzel text-[10px] tracking-wider text-muted-foreground">
        New note
      </div>
      <div class="p-3 flex flex-col gap-2">
        ...
        <div class="flex items-center gap-2">
          <label class="flex items-center gap-1.5 cursor-pointer select-none">
            ...
            <span class="font-cinzel text-[10px] tracking-wider text-muted-foreground">Private (only you)</span>
          </label>
