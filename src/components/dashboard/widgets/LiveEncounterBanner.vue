<template>
  <!-- Kept alongside the sidebar's session rail rather than folded into it: at
       barnav widths there is no sidebar, so this is the only place on the
       dashboard that says combat is live. -->
  <RouterLink
