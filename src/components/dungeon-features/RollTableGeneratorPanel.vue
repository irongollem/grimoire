        ...
        <template v-else-if="result">
          ...
          <div class="rounded-md border border-border bg-muted/30 p-4 space-y-3">
            <div class="flex items-start justify-between gap-2">
              ...
              <span class="font-cinzel text-[10px] px-1.5 py-0.5 rounded bg-primary/10 text-primary font-semibold tracking-wider shrink-0">{{ die }}</span>
            </div>
            ...
            <ul class="space-y-1.5">
              ...
              >
                <span class="font-cinzel text-[10px] text-primary font-semibold tracking-wider shrink-0 mt-0.5 w-8 text-right">
            ...
            <div v-if="result.tags.length" class="flex flex-wrap gap-1.5 pt-1">
              <span
                ...
                :key="tag"
                class="rounded-full bg-muted border border-border px-2 py-0.5 font-fell text-[10px] text-muted-foreground"
              >
                {{ tag }}
              </span>
            </div>
