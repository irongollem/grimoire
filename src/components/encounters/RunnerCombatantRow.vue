...
.conc-chip {
  @apply inline-flex items-center px-1.5 py-0.5 rounded font-cinzel text-[0.5625rem] font-semibold bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border border-indigo-500/30 cursor-pointer hover:bg-destructive/20 hover:text-destructive transition-colors;
}
