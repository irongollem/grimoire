<template>
  ...
  >
    <span v-if="item" class="font-cinzel text-2xs font-bold leading-none">{{ item.name.charAt(0) }}</span>
    <span v-else-if="!disabled" class="font-cinzel text-2xs font-bold leading-none">+</span>
  </button>
</template>
