<template>
  <div class="max-w-2xl mx-auto space-y-6">
    ...
    <div v-if="cls.asi_levels.length" class="rounded-lg border border-border bg-card overflow-hidden">
      <div class="px-3 py-2 border-b border-border bg-muted/20">
        <span class="text-label-lg font-semibold text-muted-foreground">Ability Score Increase Levels</span>
      </div>
    ...
    <div v-if="cls.spell_slots !== null" class="rounded-lg border border-border bg-card overflow-hidden">
      <div class="px-3 py-2 border-b border-border bg-muted/20">
        <span class="text-label-lg font-semibold text-muted-foreground">Spellcasting</span>
      </div>
