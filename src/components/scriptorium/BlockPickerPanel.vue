<template>
  <AppModal :open="show" size="md" panel-class="max-h-[min(40rem,90vh)]" @close="$emit('close')">
    <ModalHeader title="Insert Block" closeable @close="$emit('close')" />
...
import { IconLibrary, IconLink, IconGridView } from '@/lib/icons';
