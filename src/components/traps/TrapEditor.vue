          ...
          <div class="flex-1 grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div class="flex items-center gap-2">
                ...
                <span v-if="crXp" class="font-cinzel text-[10px] text-muted-foreground tracking-wider whitespace-nowrap">{{ crXp }} XP</span>
                <button
                  type="button"
        ...
        <div class="p-4 space-y-3">
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <button type="button" class="font-cinzel text-[10px] font-semibold text-primary hover:opacity-80 transition-opacity tracking-wider" @click="addDamageEntry">+ Add</button>
            </div>
            <div class="flex flex-col gap-2">
              <div v-for="(entry, i) in form.damage_entries" :key="i" class="flex items-center gap-2">
                ...
                <select v-model="entry.type" class="flex-1 bg-background border border-border rounded-md px-3 py-1.5 font-fell text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring capitalize">
                  <option value="">—</option>
        ...
        <div class="w-full max-w-lg bg-card border border-border rounded-xl shadow-xl flex flex-col max-h-[90vh] overflow-hidden">
          ...
          <div class="flex-1 overflow-y-auto p-5 flex flex-col gap-4">
            ...
            <div v-if="advisorResult" class="rounded-lg border border-border bg-muted/20 p-4 flex flex-col gap-3">
              ...
              <div class="font-cinzel text-[10px] text-muted-foreground tracking-wider">
              ...
              <ul class="flex flex-col gap-1">
                <li v-for="(factor, i) in advisorResult.factors" :key="i" class="font-fell text-xs text-muted-foreground flex items-start gap-1.5">
                  <span class="text-primary mt-0.5">·</span>{{ factor }}
                </li>
              </ul>
              <div class="border-t border-border pt-3">
                <div class="font-cinzel text-[10px] text-muted-foreground tracking-wider mb-2">REFERENCE BENCHMARKS</div>
