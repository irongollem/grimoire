    ...
    const unwatch = watch(
      ...
      (campaignId) => {
        ...
        activeChannel = supabase
          ...
          .on("postgres_changes", { event: "*", schema: "public", table: "npcs",               filter: f }, invalidate("npcs"))
          .on("postgres_changes", { event: "*", schema: "public", table: "companions",         filter: f }, invalidate("companions"))
          .on("postgres_changes", { event: "*", schema: "public", table: "discovered_monsters",filter: f }, invalidate("discovered-monsters"))
          .on("postgres_changes", { event: "*", schema: "public", table: "pantheons",          filter: f }, invalidate("pantheons"))
