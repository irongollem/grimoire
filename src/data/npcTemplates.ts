      ...
      special_abilities: [
        {
          name: "Spellcasting",
          description:
            "The acolyte is a 1st-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 12, +4 to hit with spell attacks). It has the following cleric spells prepared: Cantrips: light, sacred flame, thaumaturgy. 1st level (3 slots): bless, cure wounds, sanctuary.",
        },
      ],
      actions: [
        {
    ...
    stat_block: {
      ...
      special_abilities: [
        ...
        },
        {
          name: "Spellcasting",
          description:
            "4th-level cleric (DC 13, +5 to hit). Spells: light, sacred flame, thaumaturgy / bless, cure wounds, guiding bolt / hold person, spiritual weapon / dispel magic, spirit guardians.",
        },
      ],
      actions: [
        {
      ...
      special_abilities: [
        {
          ...
          description:
            "The mage has advantage on saving throws against spells and other magical effects.",
        },
        {
          name: "Spellcasting",
          description:
            "9th-level wizard (DC 14, +6 to hit). Spells: fire bolt, light, mage hand, prestidigitation / detect magic, mage armor, magic missile, shield / misty step, suggestion / counterspell, fireball, fly / greater invisibility, ice storm / cone of cold, scrying.",
        },
      ],
      actions: [
        {
      ...
      special_abilities: [
        {
          name: "Brave",
          description:
            "The knight has advantage on saving throws against the frightened condition.",
        },
      ],
      actions: [
        ...
        },
        {
          ...
          description:
            "For 1 minute, the knight can utter a special command or warning whenever a nonhostile creature it can see within 30 ft. makes an attack roll or a saving throw. That creature can add a d4 to its roll (provided it can hear and understand the knight).",
        },
      ],
    },
  },
      ...
      special_abilities: [
        {
          name: "Brave",
          description:
            "The gladiator has advantage on saving throws against the frightened condition.",
        },
        {
          name: "Brute",
          description:
      ...
      special_abilities: [
        {
          name: "Pack Tactics",
          description:
            "The captain has advantage on an attack roll against a creature if at least one of the captain's allies is adjacent to the creature and the ally isn't incapacitated.",
        },
      ],
      actions: [
        {
      ...
      special_abilities: [
        {
          name: "Pack Tactics",
          description:
            "The thug has advantage on an attack roll against a creature if at least one of the thug's allies is adjacent to the creature and the ally isn't incapacitated.",
        },
      ],
      actions: [
    ...
    stat_block: {
      ...
      special_abilities: [
        ...
        },
        {
          name: "Sneak Attack (1/Turn)",
          description:
            "The assassin deals an extra 14 (4d6) damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 ft. of an ally of the assassin that isn't incapacitated and the assassin doesn't have disadvantage on the attack roll.",
        },
      ],
      actions: [
    ...
    stat_block: {
      ...
      special_abilities: [
        ...
        },
        {
          name: "Spellcasting",
          description:
            "4th-level cleric (DC 12, +4 to hit). Cantrips: light, sacred flame, thaumaturgy. 1st level (4 slots): command, inflict wounds, shield of faith. 2nd level (3 slots): hold person, spiritual weapon.",
        },
      ],
      actions: [
