...
export const QUEST_BEAT_ATTACHMENT_ADAPTERS: Record<QuestBeatAttachmentType, QuestBeatAttachmentAdapter> = {
  ...
  objective: { type: "objective", label: "Objective", runAction: "manage", containedSurface: "objective", summary, fullEditorTo: (_id, questId) => `/quests/${questId}?edit=true` },
  quest_ref: { type: "quest_ref", label: "Quest reference", runAction: "view", containedSurface: "entity", summary, fullEditorTo: (_id, questId) => `/quests/${questId}?edit=true` },
