...
- **Ranged weapons & ammunition**: ammo tags (`arrow`, `bolt`, `bullet`, `needle`, `dart`, `firearm-bullet`) link ammunition to the correct ranged weapon. Grimoire also recognises a weapon's name/subtype directly for standard weapons, so tags matter most for anything with an unusual name.
