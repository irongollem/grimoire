...
Picking a faction or an associate here creates that membership or connection automatically the moment the NPC is created — you don't need a second trip to the Relations tab.
