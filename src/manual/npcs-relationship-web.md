...
Connections use a 15-type taxonomy. Storing a type from one NPC's side automatically reads as its inverse from the other side — you only ever set it once:
