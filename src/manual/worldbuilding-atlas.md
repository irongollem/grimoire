...
These three types get an **Inventory** section: add items from your Vault with quantities and optional prices, and restock directly from the place's own page without entering edit mode. Link a **Proprietor** NPC to put a face on the vendor — it's used as the sender name on in-chat vendor offers.
