          ...
          <div class="p-4 flex gap-4">
            ...
            <div class="flex-1 grid grid-cols-2 gap-3">
              ...
              <div class="col-span-2">
                ...
                >
                  <option
                    v-for="t in DUNGEON_FEATURE_TYPES"
                    :key="t"
                    :value="t"
                  >
                    {{ t }}
          ...
          <div class="p-4 flex flex-col gap-3">
            <div>
              ...
              >
                ...
                <option
                  v-for="t in DUNGEON_FEATURE_TRIGGERS"
                  :key="t"
                  :value="t"
                >
                  {{ t }}
    ...
    if (f)
      Object.assign(form.value, {
        ...
        contents_description: f.contents_description
          ? typeof f.contents_description === "string"
            ? f.contents_description
            : JSON.stringify(f.contents_description)
          : null,
