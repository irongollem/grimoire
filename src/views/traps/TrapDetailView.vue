            ...
            <div>
              ...
              <div class="grid grid-cols-5 gap-1.5">
                <button
                  ...
                  :class="advisorInputs.effectCategory === cat.value
            ...
            <div>
              ...
              <div class="grid grid-cols-3 gap-1.5">
                <button
                  ...
                  type="button"
                  class="rounded-md border px-2 py-1.5 font-cinzel text-[10px] font-semibold tracking-wider transition-colors text-center"
                  :class="advisorInputs.targeting === opt.value
                    ? 'border-primary bg-primary/10 text-primary'
                    : 'border-border text-muted-foreground hover:border-primary/50'"
            ...
            <div>
              ...
              <div class="grid grid-cols-4 gap-1.5">
                <button
                  ...
                  type="button"
                  class="rounded-md border px-2 py-1.5 font-cinzel text-[10px] font-semibold tracking-wider transition-colors text-center"
                  :class="advisorInputs.dcTier === opt.value
                    ? 'border-primary bg-primary/10 text-primary'
                    : 'border-border text-muted-foreground hover:border-primary/50'"
            ...
            <div>
              ...
              <div class="grid grid-cols-5 gap-1.5">
                <button
                  ...
                  type="button"
                  class="rounded-md border px-2 py-1.5 font-cinzel text-[10px] font-semibold tracking-wider transition-colors text-center"
                  :class="advisorInputs.secondaryEffect === opt.value
                    ? 'border-primary bg-primary/10 text-primary'
                    : 'border-border text-muted-foreground hover:border-primary/50'"
...
import type { TrapEffectCategory, TrapTargeting, TrapDcTier, TrapSecondaryEffect } from "@/lib/trapAdvisor";
