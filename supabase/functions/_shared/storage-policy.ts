...
// renamed here.
//
// MIME/size limits are mirrored from `BUCKETS` in src/lib/storage.ts, which in
// turn mirrors the SQL. A test in src/lib/storage.test.ts fails if the two drift.
