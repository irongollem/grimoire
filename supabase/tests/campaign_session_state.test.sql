...
select public.transition_quest_runtime(
  '75800000-0000-4000-8000-000000000010', '75800000-0000-4000-8000-000000000020', (select id from public.quest_threads where quest_id = '75800000-0000-4000-8000-000000000020' and label = 'Main'), 'start', 0,
