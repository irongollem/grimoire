...
insert into public.quest_runtime_state (campaign_id, quest_id, current_beat_id, status, version, visit_stack, visit_index) values (
...
select is((select current_beat_id from public.quest_runtime_state where campaign_id = '68700000-0000-4000-8000-000000000010' and quest_id = '68700000-0000-4000-8000-000000000020'), '68700000-0000-4000-8000-000000000031'::uuid, 'cursor moves to replacement');
...
select throws_ok(
  $$ select public.archive_quest_beat('68700000-0000-4000-8000-000000000031', 4, '68700000-0000-4000-8000-000000000033', false) $$,
